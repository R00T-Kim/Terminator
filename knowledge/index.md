...
| Auth0 by Okta | Bugcrowd | SDK (nextjs-auth0, passport-wsfed-saml2) + Live (manage.cic-bug-bounty) | **2 READY TO SUBMIT (2026-03-10)** — VUL-G: nextjs-auth0 handleLogout returnTo open redirect (CWE-601, CVSS 6.1 P4). VUL-B: passport-wsfed-saml2 XML comment NameID bypass (CWE-116/290, CVSS 8.0 P2-P3, E2E PoC Tier 1 Gold). VUL-D/E/F: cross-tenant IDOR/BOLA (P1-P2, blocked on MFA/browser). VUL-A: XSW parked (lab negative). | `targets/auth0/submission/` |
