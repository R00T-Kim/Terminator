...
- **자동 품질 게이트 (v11 Kill Gate 포함)** -- 6개 파이프라인 스킬 + 2 Kill Gates(v11)가 OOS finding, 약한 PoC, 비현실적 위협 모델, AI 템플릿 언어를 제출 전 자동 차단
...
### 버그바운티 -- v11 파이프라인 (Kill Gate)

> [!IMPORTANT]
> **철칙**: Exploit 없으면, Report 없음. 작동하는 PoC 없는 발견사항은 자동 폐기.

<details>
<summary><b>Kill Gate 파이프라인 상세 (v11)</b></summary>
...
**6개 자동 파이프라인 스킬 + 2 Kill Gates (v11):**
...
- ★ Gate 1 + Gate 2: Kill Gate가 PoC 개발 전 + 보고서 작성 전에 finding을 차단 (v11 NEW)
