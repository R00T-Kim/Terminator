...
| **lightpanda** | 경량 헤드리스 브라우저 (메모리 9x↓, 속도 11x↑): 페이지 fetch, markdown, links, JS eval, semantic tree |
| **browser-use** | AI 브라우저 자동화: 자연어 웹 작업, 데이터 추출, 스크린샷 |
| **opendataloader-pdf** | PDF 파싱: markdown, JSON (바운딩 박스), 테이블 추출, HTML |
